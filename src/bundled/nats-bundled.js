...
function headers$1(code = 0, description = "") {
...
function newJsErrorMsg(code, description, subject) {
    const h = headers$1(code, description);
    const arg = {
        hdr: 1,
        sid: 0,
        size: 0
    };
    const msg = new MsgImpl(arg, Empty$1, {});
    msg._headers = h;
...
var m = e.performance || {}; m.now || m.mozNow || m.msNow || m.oNow || m.webkitNow || function() {
    return (new Date).getTime();
};
var E = {
    versions: {}}, S = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {};
function T(t) {
...
k = x, function() {
    ...
    var y = function(t, e) {
        return function(r) {
            return new v(e, true).update(r)[t]();
        };
    }, p = function(t) {
        var e = y("hex", t);
        ...
        return function(r, i) {
            return new A(r, e, true).update(i)[t]();
        };
    }, b = function(t) {
        var e = w("hex", t);
        e.create = function(e) {
    ...
    function v(t, e) {
        e ? (l[0] = l[16] = l[1] = l[2] = l[3] = l[4] = l[5] = l[6] = l[7] = l[8] = l[9] = l[10] = l[11] = l[12] = l[13] = l[14] = l[15] = 0, this.blocks = l) : this.blocks = [
            ...
            0,
            0
        ], t ? (this.h0 = 3238371032, this.h1 = 914150663, this.h2 = 812702999, this.h3 = 4144912697, this.h4 = 4290775857, this.h5 = 1750603025, this.h6 = 1694076839, this.h7 = 3204075428) : (this.h0 = 1779033703, this.h1 = 3144134277, this.h2 = 1013904242, this.h3 = 2773480762, this.h4 = 1359893119, this.h5 = 2600822924, this.h6 = 528734635, this.h7 = 1541459225), this.block = this.start = this.bytes = this.hBytes = 0, this.finalized = this.hashed = false, this.first = true, this.is224 = t;
    }
    function A(e, r, i) {
        var h, s = typeof e;
        if ("string" === s) {
        ...
        e.length > 64 && (e = new v(r, true).update(e).array());
        var c = [], l = [];
        for(h = 0; h < 64; ++h){
            var y = e[h] || 0;
            c[h] = 92 ^ y, l[h] = 54 ^ y;
        }
        v.call(this, r, i), this.update(l), this.oKeyPad = c, this.inner = true, this.sharedMemory = i;
    }
    v.prototype.update = function(e) {
        if (!this.finalized) {
            ...
            for(var h, s, o = 0, a = e.length, u = this.blocks; o < a;){
                if (this.hashed && (this.hashed = false, u[0] = this.block, this.block = u[16] = u[1] = u[2] = u[3] = u[4] = u[5] = u[6] = u[7] = u[8] = u[9] = u[10] = u[11] = u[12] = u[13] = u[14] = u[15] = 0), r) for(s = this.start; o < a && s < 64; ++o)u[s >>> 2] |= e[o] << f[3 & s++];
                ...
                this.lastByteIndex = s, this.bytes += s - this.start, s >= 64 ? (this.block = u[16], this.start = s - 64, this.hash(), this.hashed = true) : this.start = s;
            }
    ...
    var g = p();
    g.sha256 = g, g.sha224 = p(true), g.sha256.hmac = b(), g.sha224.hmac = b(true), s ? k.exports = g : (r.sha256 = g.sha256, r.sha224 = g.sha224);
}();
x.exports; x.exports.sha224; var J = x.exports.sha256;
...
class MuxSubscription {
    ...
    init(prefix) {
        this.baseInbox = `${createInbox$1(prefix)}.`;
...
function nkeyAuthenticator$1(seed) {
    return (nonce)=>{
...
function jwtAuthenticator$1(ajwt, seed) {
    return (nonce)=>{
        const jwt = typeof ajwt === "function" ? ajwt() : ajwt;
        const fn = nkeyAuthenticator$1(seed);
...
function credsAuthenticator(creds) {
    ...
    return jwtAuthenticator$1(jwtFn, nkeyFn);
}
...
function parseOptions(opts) {
    ...
    if (options.inboxPrefix) {
        try {
            createInbox$1(options.inboxPrefix);
        } catch (err) {
...
class ProtocolHandler {
    ...
    publish(subject, payload = Empty$1, options) {
        let data;
...
class ServiceMsgImpl {
    ...
    respondError(code, description, data, opts) {
        opts = opts || {};
        opts.headers = opts.headers || headers$1();
...
class ServiceClientImpl {
    ...
    async q(v, name = "", id = "") {
        ...
        const responses = await this.nc.requestMany(subj, Empty$1, this.opts);
        (async ()=>{
...
class Bench {
    ...
    constructor(nc, opts = {
        ...
        this.perf = new Perf();
        this.payload = this.size ? new Uint8Array(this.size) : Empty$1;
...
class Bucket {
    ...
    async _doDeleteOrPurge(k, op, opts) {
        ...
        await this.js.publish(this.subjectForKey(ek, true), Empty$1, {
            headers: h
        });
    }
...
class PullConsumerMessagesImpl extends QueuedIteratorImpl {
    ...
    constructor(c, opts, refilling = false){
        ...
        this.timeout = null;
        this.inbox = createInbox$1(c.api.nc.options.inboxPrefix);
        this.listeners = [];
...
class DirectStreamAPIImpl extends BaseApiClient {
    ...
    async getMessage(stream, query) {
        ...
        const payload = qq ? this.jc.encode(qq) : Empty$1;
...
class StoredMsgImpl {
    ...
    get data() {
        return this.smr.message.data ? this._parse(this.smr.message.data) : Empty$1;
    }
    get header() {
        if (!this._header) {
...
class JetStreamClientImpl extends BaseApiClient {
    ...
    async publish(subj, data = Empty$1, opts) {
        opts = opts || {};
        opts.expect = opts.expect || {};
        const mh = opts?.headers || headers$1();
        if (opts) {
            if (opts.msgID) {
    ...
    fetch(stream, durable, opts = {}) {
        ...
        const inbox = createInbox$1(this.nc.options.inboxPrefix);
    ...
    async pullSubscribe(subject, opts = consumerOpts$1()) {
    ...
    async subscribe(subject, opts = consumerOpts$1()) {
        const cso = await this._processOptions(subject, opts);
    ...
    async _processOptions(subject, opts = consumerOpts$1()) {
        ...
        if (jsi.ordered) {
            ...
            jsi.config.deliver_subject = createInbox$1(this.nc.options.inboxPrefix);
        ...
        jsi.deliver = jsi.config.deliver_subject || createInbox$1(this.nc.options.inboxPrefix);
        return jsi;
    }
...
class NatsConnectionImpl {
    ...
    requestMany(subject, data = Empty$1, opts = {
        maxWait: 1000,
        maxMessages: -1
    }) {
        ...
        if (opts.noMux) {
            ...
            const sub = this.subscribe(createInbox$1(this.options.inboxPrefix), {
                callback: (err, msg)=>{
    ...
    request(subject, data, opts = {
        ...
        if (opts.noMux) {
            const inbox = opts.reply ? opts.reply : createInbox$1(this.options.inboxPrefix);
            const d = deferred();
...
class JetStreamSubscriptionImpl extends TypedSubscription {
    ...
    _resetOrderedConsumer(sseq) {
        ...
        const newDeliver = createInbox$1(this.js.nc.options.inboxPrefix);
        const nci = this.js.nc;
...
class JsMsgImpl {
    ...
    nak(millis) {
        let payload = NAK;
        if (millis) {
            payload = StringCodec$1().encode(`-NAK ${JSON.stringify({
                delay: nanos(millis)
            })}`);
        }
        this.doAck(payload);
    ...
    term(reason = "") {
        let term = TERM;
        if (reason?.length > 0) {
            term = StringCodec$1().encode(`+TERM ${reason}`);
        }
        this.doAck(term);
    }
    json() {
...
var natsws = /*#__PURE__*/Object.freeze({
    __proto__: null,
    get AckPolicy () { return AckPolicy; },
    get AdvisoryKind () { return AdvisoryKind; },
    Bench: Bench,
    get ConsumerDebugEvents () { return ConsumerDebugEvents; },
    get ConsumerEvents () { return ConsumerEvents; },
    get DebugEvents () { return DebugEvents; },
    get DeliverPolicy () { return DeliverPolicy; },
    get DirectMsgHeaders () { return DirectMsgHeaders; },
    get DiscardPolicy () { return DiscardPolicy; },
    Empty: Empty$1,
    get ErrorCode () { return ErrorCode; },
    get Events () { return Events; },
    JSONCodec: JSONCodec,
    get JsHeaders () { return JsHeaders; },
    get KvWatchInclude () { return KvWatchInclude; },
    get Match () { return Match; },
    Metric: Metric,
    MsgHdrsImpl: MsgHdrsImpl,
    NatsError: NatsError,
    Nuid: Nuid,
    get ReplayPolicy () { return ReplayPolicy; },
    get RepublishHeaders () { return RepublishHeaders; },
    get RequestStrategy () { return RequestStrategy; },
    get RetentionPolicy () { return RetentionPolicy; },
    ServiceError: ServiceError,
    ServiceErrorCodeHeader: ServiceErrorCodeHeader,
    ServiceErrorHeader: ServiceErrorHeader,
    get ServiceResponseType () { return ServiceResponseType; },
    get ServiceVerb () { return ServiceVerb; },
    get StorageType () { return StorageType; },
    get StoreCompression () { return StoreCompression; },
    ...
    connect: connect$1,
    consumerOpts: consumerOpts$1,
    createInbox: createInbox$1,
    ...
    jwtAuthenticator: jwtAuthenticator$1,
    millis: millis,
    nanos: nanos,
    nkeyAuthenticator: nkeyAuthenticator$1,
    nkeys: mod,
    nuid: nuid,
...
const { connect, StringCodec, Empty, createInbox, headers, consumerOpts, jwtAuthenticator, nkeyAuthenticator, } = natsws;
